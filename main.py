...
if page=="Sales Entry":
    ...
    for i, entry in enumerate(st.session_state.multi_entries):
        # Column widths: Nozzle=1, Fuel=1, Opening=2, Closing=2, Litres=0.9, Amount=0.9
        cols = st.columns([1,1,2,2,0.9,0.9])
